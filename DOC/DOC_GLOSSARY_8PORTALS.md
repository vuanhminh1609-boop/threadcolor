...
| Tự-quét (self-hit) | Tự-quét (self-hit) | Trường hợp công cụ quét phát hiện mẫu nghi vấn nằm trong chính file báo cáo do nó vừa sinh ra, gây nhiễu kết quả nếu không lọc. |
